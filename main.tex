...
\begin{table}[H]{Khả năng cân bằng theo khối lượng đối trọng}
\centering
\begin{tabular}{|c|c|l|}
\hline
...
\begin{figure}[H]{Mô hình hệ thống khung đế cân bằng trọng tâm}
\centering
\includegraphics[width=\textwidth]{hinh/sp.jpg}
\end{figure}
...
\begin{figure}[H]{Kiểm tra cụm loadcell bên TRÁI}
\centering
\includegraphics[height=0.5\textheight]{hinh/trai.jpg}
\end{figure}

\begin{figure}[H]{Kiểm tra cụm loadcell bên PHẢI}
\centering
\includegraphics[height=0.4\textheight]{hinh/phai.jpg}
\end{figure}
...
\begin{figure}[H]{Thực nghiệm cân bằng với vật nặng bên TRÁI}
\centering
\includegraphics[height=0.6\textheight]{hinh/canbang.jpg}
\end{figure}
...
\begin{figure}[H]{Mô hình thử nghiệm tổng hợp với nhiều kịch bản tải}
\centering
\includegraphics[width=\textwidth]{hinh/canbang2.jpg}
\end{figure}
