...
Khả năng cân bằng phụ thuộc vào khối lượng đối trọng và hành trình. Công thức tính độ lệch tối đa có thể bù được:
\begin{equation}
m_{load,max} = 0.69 \times m_{slider}
\end{equation}

Trong thử nghiệm với đối trọng 200g:
\begin{itemize}
    \item Độ lệch tối đa bù được: $0.69 \times 200 \approx 137$g
    \item Tải vượt khả năng: $>$ 137g (con trượt chạm giới hạn, còn lệch $>$100g)
\end{itemize}

Bảng tra cứu khả năng cân bằng theo khối lượng đối trọng (với khung 35cm, hành trình 120mm):
...
1000g & $\sim$686g & Khuyên nghị ứng dụng nặng \\
\hline
1500g & $\sim$1029g & Sử dụng pin/acquy làm đối trọng \\
\hline
\end{tabular}
\end{table}

\textbf{Nhận xét}: Giới hạn cân bằng phụ thuộc vào khối lượng đối trọng. Hệ số 0.69 được xác định từ tỷ lệ cánh tay đòn: $\frac{d_{slider,max}}{d_{load}} = \frac{120}{175} \approx 0.69$. Để tăng khả năng cân bằng, cần tăng khối lượng đối trọng hoặc sử dụng pin/acquy nặng làm đối trọng.
...
\begin{enumerate}
    ...
    \item \textbf{Giới hạn tải}:
    \begin{itemize}
        \item Nguyên nhân: Với đối trọng 200g chỉ bù được $\sim$137g (công thức: $m_{load,max} = 0.69 \times m_{slider}$)
        \item Giải pháp: Tăng khối lượng đối trọng (ví dụ: dùng pin/acquy 1kg có thể bù được $\sim$690g)
    \end{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Độ chính xác ±100g (đạt yêu cầu)
...
\begin{enumerate}
    ...
    \item \textbf{Giới hạn tải}: Với đối trọng thử nghiệm 200g, chỉ bù được độ lệch $\sim$137g. Công thức: $m_{load,max} = 0.69 \times m_{slider}$. Cần tăng khối lượng đối trọng để tăng khả năng cân bằng.
