...
\begin{table}[H]
\centering
\caption{Tham số cấu hình hệ thống trong thử nghiệm}
...
\begin{table}[H]
\centering
\caption{Kết quả kiểm tra độ chính xác cảm biến với vật chuẩn 210g}
...
\begin{table}[H]
\centering
\caption{So sánh hiệu năng với các giá trị $K_p$ khác nhau}
...
\end{axis}
\end{tikzpicture}
\caption{So sánh thời gian xác lập với các giá trị $K_p$ khác nhau}
...
\end{axis}
\end{tikzpicture}
\caption{Đường cong đáp ứng -- Diễn biến độ lệch theo thời gian với các giá trị $K_p$}
...
\begin{table}[H]
\centering
\caption{Timeline thử nghiệm tổng hợp với nhiều kịch bản tải}
...
\end{axis}
\end{tikzpicture}
\caption{Diễn biến độ lệch trong thử nghiệm tổng hợp}
...
\begin{table}[H]
\centering
\caption{Tổng hợp hiệu năng bộ điều khiển PID}
...
\end{tikzpicture}
\caption{Sơ đồ cơ chế Hysteresis với ngưỡng bật $\pm$110g và ngưỡng tắt $\pm$90g}
...
\begin{table}[H]
\centering
\caption{So sánh hiệu năng Non-blocking và Blocking}
...
\begin{table}[H]
\centering
\caption{So sánh kết quả với mục tiêu đề ra}
...
\begin{table}[H]
\centering
\caption{Tổng hợp kết quả định lượng từ thực nghiệm}
